  ...
  "differential" : {
    "element" : [{
      ...
      "constraint" : [{
        ...
        "severity" : "error",
        "human" : "If present, Facility Code must be ZW followed by the 6-character national facility code, which is composed of the 2-digit province code (01-10) + 2-digit district + 2-character facility number (i.e. province code + district = district code, e.g. 0132; + facility = facility code, e.g. 013224). The facility number is alphanumeric; hospitals typically include a letter (examples: ZW010245, ZW03090D).",
