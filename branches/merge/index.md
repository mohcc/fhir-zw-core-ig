...
| Draft as of 2026-06-11 | *Computable Name*:ZWCore |
...
```json
{
  ...
  "id" : "zw.fhir.ig.core",
  "url" : "http://mohcc.gov.zw/fhir/core/ImplementationGuide/zw.fhir.ig.core",
  "version" : "0.1.0",
  "name" : "ZWCore",
  "title" : "Zimbabwe Core IG",
  "status" : "draft",
  "experimental" : false,
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "http://mohcc.gov.zw/fhir/core/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      "name" : "Example Allergy (Penicillin)",
      "description" : "A confirmed high-criticality penicillin allergy for the example patient.",
      "exampleCanonical" : "http://mohcc.gov.zw/fhir/core/StructureDefinition/zw-allergy-intolerance"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "name" : "Example Condition (Malaria)",
      "description" : "A confirmed malaria diagnosis for the example Zimbabwean patient.",
      "exampleCanonical" : "http://mohcc.gov.zw/fhir/core/StructureDefinition/zw-condition"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "name" : "Example Encounter (Outpatient Visit)",
      "description" : "An ambulatory outpatient visit for the example Zimbabwean patient at Parirenyatwa.",
      "exampleCanonical" : "http://mohcc.gov.zw/fhir/core/StructureDefinition/zw-encounter"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "exampleCanonical" : "http://mohcc.gov.zw/fhir/core/StructureDefinition/zw-immunization"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "name" : "Example Medication Request (Antimalarial)",
      "description" : "An antimalarial prescription for the example patient diagnosed with malaria.",
      "exampleCanonical" : "http://mohcc.gov.zw/fhir/core/StructureDefinition/zw-medication-request"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "name" : "Example Observation (Body Weight)",
      "description" : "A body weight measurement for the example Zimbabwean patient.",
      "exampleCanonical" : "http://mohcc.gov.zw/fhir/core/StructureDefinition/zw-observation"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "name" : "Example Procedure (Malaria RDT)",
      "description" : "A malaria rapid diagnostic test performed for the example patient.",
      "exampleCanonical" : "http://mohcc.gov.zw/fhir/core/StructureDefinition/zw-procedure"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "name" : "Example Related Person (Next of Kin)",
      "description" : "Next of kin for the example Zimbabwean patient.",
      "exampleCanonical" : "http://mohcc.gov.zw/fhir/core/StructureDefinition/zw-related-person"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "name" : "Example Zimbabwean Health Facility",
      "description" : "Parirenyatwa Group of Hospitals, a central hospital in Harare.",
      "exampleCanonical" : "http://mohcc.gov.zw/fhir/core/StructureDefinition/zw-organization"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "name" : "Example Zimbabwean Location",
      "description" : "The outpatients department at Parirenyatwa Group of Hospitals.",
      "exampleCanonical" : "http://mohcc.gov.zw/fhir/core/StructureDefinition/zw-location"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "name" : "Example Zimbabwean Patient",
      ...
      "exampleCanonical" : "http://mohcc.gov.zw/fhir/core/StructureDefinition/zw-patient"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "name" : "Example Zimbabwean Patient (Tinashe Muti)",
    ...
    },
    {
      ...
      "name" : "Example Zimbabwean Practitioner",
      "description" : "A registered nurse with a council registration number and national identity.",
      "exampleCanonical" : "http://mohcc.gov.zw/fhir/core/StructureDefinition/zw-practitioner"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/ZimMaritalStatus"
      },
      "name" : "MaritalStatus Value Set",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/zw-allergy-intolerance"
      },
      "name" : "Zimbabwe Allergy Intolerance",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/zw-condition"
      },
      "name" : "Zimbabwe Condition",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CodeSystem/ZimCountryCS"
      },
      "name" : "Zimbabwe Country (Nationality) Code System",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/ZimCountry"
      },
      "name" : "Zimbabwe Country (Nationality) Value Set",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CodeSystem/ZimDistrictCS"
      },
      "name" : "Zimbabwe District Code System",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/ZimDistrict"
      },
      "name" : "Zimbabwe District Value Set",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/zw-encounter"
      },
      "name" : "Zimbabwe Encounter",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "NamingSystem/zw-facility-code-ns"
      },
      "name" : "Zimbabwe Health Facility Code Namespace",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CodeSystem/ZimFacilityTypeCS"
      },
      "name" : "Zimbabwe Health Facility Type Code System",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/ZimFacilityType"
      },
      "name" : "Zimbabwe Health Facility Type Value Set",
      "description" : "Tiers of health facility in the Zimbabwe public health system.",
      "exampleBoolean" : false
    },
    {
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/ZimLanguage"
      },
      "name" : "Zimbabwe Language Value Set",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/zw-location"
      },
      "name" : "Zimbabwe Location",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/zw-medication-request"
      },
      "name" : "Zimbabwe Medication Request",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "NamingSystem/zw-national-identity-ns"
      },
      "name" : "Zimbabwe National Identity Namespace",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/zw-observation"
      },
      "name" : "Zimbabwe Observation",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/zw-organization"
      },
      "name" : "Zimbabwe Organization",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "NamingSystem/zw-passport-ns"
      },
      "name" : "Zimbabwe Passport Number Namespace",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/zw-patient"
      },
      "name" : "Zimbabwe Patient",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "NamingSystem/zw-phid-ns"
      },
      "name" : "Zimbabwe Patient Health ID (PHID) Namespace",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/zw-practitioner"
      },
      "name" : "Zimbabwe Practitioner",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "NamingSystem/zw-practitioner-registration-ns"
      },
      "name" : "Zimbabwe Practitioner Registration Number Namespace",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/zw-procedure"
      },
      "name" : "Zimbabwe Procedure",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CodeSystem/ZimProvinceCS"
      },
      "name" : "Zimbabwe Province Code System",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/ZimProvince"
      },
      "name" : "Zimbabwe Province Value Set",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/zw-related-person"
      },
      "name" : "Zimbabwe Related Person",
